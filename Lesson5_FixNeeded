...
def game_scene():
    ...
    while True:
        ...
        for bullet_number in range(len(bullets)):
            ...
            # if direction == "Up": 
                # bullets[bullet_number].move(bullets[bullet_number].x,bullets[bullet_number].y - constants.BULLET_SPEED)
            #if direction == "Down":
                # bullets[bullet_number].move(bullets[bullet_number].x, bullets[bullet_number].y + constants.BULLET_SPEED)
            # if direction == "Left":
                # bullets[bullet_number].move(bullets[bullet_number].x - constants.BULLET_SPEED, bullets[bullet_number].y)
            # if direction == "Right":
                # bullets[bullet_number].move(bullets[bullet_number].x + constants.BULLET_SPEED, bullets[bullet_number].y)
